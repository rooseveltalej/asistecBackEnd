...
def get_user_activities_route(user_id: str, db: Session = Depends(get_db)):
...
def update_activity_route(activity_id: str, activity: schemas.ActivityCreate, db: Session = Depends(get_db)):
